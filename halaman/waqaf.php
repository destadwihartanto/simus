                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                      <th colspan="5" style="text-align: center;font-size: 17px">Total Penerimaan Waqaf</th>
                                      <th colspan="2" style="text-align: right;font-size: 17px"><?php echo"Rp.".number_format($total).",-"  ; ?></th>
                                    </tr>
                                    <tr>
                                      <th colspan="5" style="text-align: center;font-size: 17px">Total Pengeluaran Waqaf</th>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Cari Data Laporan Waqaf</h4>
                                        </div>
                                        <div class="modal-body">
                                            <form action="halaman/laporan2.php" method="POST"  >
