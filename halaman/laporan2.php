                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody> <?php
                                         ...
                                         $no = 1;
                                         $data = mysqli_query($koneksi,"SELECT * from waqaf WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  ");
                            ...
                            <div class="panel-body">
                           <a href="../?halaman=waqaf" class="btn btn-success btn-lg"> Kembali</a>
                          </div>
