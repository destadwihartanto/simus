...
<p align="center"><b>Laporan Data Keuangan Waqaf Pembangunan</b></p>
	...
	<tbody>
		 <?php
		       ...
		       $tanggal_akhir = $_POST['tanggal_akhir'];
                ...
                $no = 1;
                $data = $koneksi->query("SELECT * from waqaf WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  ");
	 ...
	 <tr>
        <th colspan="4">Total Pemasukkan Dan Pengeluaran</th>
